#Post processing script for POE Fall 2013 Lab 3
#Initialize the required packages
require(ggplot2)
require(grid)

#Load in data for the sweep function and reformat it for ggplot2
...
#Load in and reformat for ggplot2 the step data
...
#Load the encoder data and plot
